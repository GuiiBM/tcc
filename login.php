...
// Login e cadastro: e-mail/senha e login social (Facebook, Apple).
iniciarSessaoSegura();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao'])) {
    if ($_POST['acao'] === 'login') {
        ...
        $user = null;
        garantirContaAdmin($conexao, $email);
        if ($bloqueio) {
...
<main class="auth-page">
    <a class="auth-brand" href="index.php"><img src="Componentes/icones/logo.png" alt="" width="44" height="44"> Ressonance</a>
