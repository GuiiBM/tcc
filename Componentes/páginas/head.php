<?php include_once __DIR__ . "/php/url-helper.php"; ?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    ...
    <base href="<?php echo htmlspecialchars(getBasePath()); ?>">
    ...
    <script src="Componentes/configuracoes/JS/zoomControl.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/musicPlayer.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/curtidas.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/artistaAutocomplete.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/randomizeMusics.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/dragScroll.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/artistsLayout.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/tooltip.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/artistPopup.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/autoUpdateDescriptions.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/enhancedInteractions.js?v=<?php echo time(); ?>" defer></script>
    <script src="Componentes/configuracoes/JS/atualizarVisualizacoes.js?v=<?php echo time(); ?>" defer></script>
